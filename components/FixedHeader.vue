<template>
  <nav class="fixed w-full p-6 bg-transparent">
    <div class="flex items-center justify-end">
      <!-- Header logo -->
      <div class="w-14 h-14 absolute m-auto left-0 right-0 ">
        <img src="transparantLogo.png" alt="HDFLOGO">
      </div>
      ...
      <aside class="p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="divide-y font-sans">
          ...
          <li><a href="/merchsoon" @click="isOpen = false" class="my-4 inline-block">Merch</a></li>
          <li><a href="/newsletter" @click="isOpen = false" class="my-4 inline-block">Newsletter</a></li>
          <li><a href="/members" @click="isOpen = false" class="my-4 inline-block">Members</a></li>
          <li><a href="/contact" @click="isOpen = false" class="my-4 inline-block mb-56">Contact</a></li>
